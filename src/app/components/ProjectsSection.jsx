...
const projectsData = [
  {
    ...
    description: "This is my portfolio website. It is built using Next.js, Tailwind CSS, Framer-Motion. It has a fully responsive design. It has a contact form which can be used to send me an email without the need to login anywhere. For this, I have used Nodemailer.",
